        ...
        <div className="w-[80%] hr-[2549px] top-[55px] gap-5 flex flex-col  bg-blue-500">
          ...
          <div className="w-full h-[30px] bg-white  gap-5  mt-4 flex flex-row justify-between items-center">
            ...
            <div className="flex items-center w-full  h-[24px] gap-2 bg-gray-200 rounded">
              ...
              <div className="flex items-center">
                ...
                <h1 className="font-bold text-lg text-[#6B7280]"></h1>
          ...
          <div className="w-full h-[750px]  bg-slate-500 rounded-lg  gap-[20px] flex flex-row">
            <div className="h-full w-[80%] bg-red-700 flex flex-col  ">
              ...
              <img src="" className="w-full h-[400px] bg-blue-200 rounded-tl-2xl" alt="Product" />

              <div className="w-full h-[330px] bg-emerald-300 p-5 gap-2.5 flex flex-col items-start self-stretch text-[#6B7280]">
                <input className="font-bold text-lg w-full rounded-md pl-2 border-[1px] focus:outline-none border-[#D1D5DB]" placeholder="Intelligent Finite Elements in Structural mechanics" />
                <textarea id="text" name="text"  className="border-[1px] focus:outline-none border-[#D1D5DB] text-[14px] font-normal h-[203px] w-full rounded-md" placeholder=""
                 />
                <span></span>
          ...
          {/* Details Section */}
          <div className="w-full h-[230px] bg-yellow-200 self-stretch flex items-start flex-col py-[30px] px-[20px]  gap-2.5 rounded-lg">
            ...
            <div className="w-full h-full bg-white gap-5 flex flex-col items-start self-stretch">
              ...
              <div className="w-full h-full flex flex-col justify-center items-start gap-[20px] bg-lime-400">
                <div className=" flex items-start gap-10 self-stretch">
                  <div className="w-[525px] h-[58px] bg-gray-300 flex items-start gap-[5px] flex-1" >
                    {/* <img src="" alt="" /> */}
                    ...
                    <div className="flex flex-col items-start gap-[10px] flex-1">
                      ...
                      <div className="flex flex-row w-full h-[24px] bg-red-500 items-center gap-[5px] ">
                        ...
                        <p className="flex h-[24px] text-base items-center gap-[10px] bg-[#E5E7EB] rounded-[20px] px-[14px]">
                        </p>
                  ...
                  <div className="w-[525px] h-[58px] bg-white flex items-start gap-[5px] flex-1">
                ...
                <div className=" flex items-start gap-10 self-stretch">
                  ...
                  <div className="w-[525px] h-[58px] bg-green-200 flex items-start gap-[5px] flex-1">
                    ...
                    <div className="flex flex-col items-start gap-[10px] flex-1">
                      ...
                      <div className="flex flex-row w-full h-[24px] bg-red-500 items-center gap-[5px] ">
                        ...
                        <p className="flex text-sm h-[29px] px-[18px]  items-center gap-[10px] bg-[#E5E7EB] rounded-[20px]">
                        </p>
                  ...
                  <div className="w-[525px] h-[58px] bg-slate-600 flex items-start gap-[5px] flex-1">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <div className="flex flex-col items-start gap-[10px] flex-1">
                      ...
                      <div className="flex flex-row w-full h-[24px] bg-red-500 items-center gap-[5px] ">
                        <p className="flex h-[24px] items-center gap-[5px] rounded-[20px] bg-[#E5E7EB] px-[14px] py-[5px]"></p>
